...
from tensorflow.keras.layers import (
    ...
    SeparableConv1D, MaxPooling1D, GlobalMaxPooling1D, LSTM, Dense, Concatenate, Bidirectional
)
...
# Define SQLGuardNet model with BiLSTM + Transformer + Depthwise CNN
def build_sqlguardnet():
    ...
    # BiLSTM Branch
    bilstm_out = Bidirectional(LSTM(D_LSTM))(x_embed)

    # Merge and classify
    concat = Concatenate()([trans_pool, cnn_pool, bilstm_out])
